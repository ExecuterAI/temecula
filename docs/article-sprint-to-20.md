# Bellie Acres — 12 guides to reach ~20 articles

**Cadence:** 2 substantive guides/day (≥800 words each)  
**Start count:** 8 long-form guides  
**Target:** 20  
**AdSense review unlock:** ~Sep 12, 2026 (do not thrash reviews before then)

## Rules
- Original, practical Temecula trip writing (not thin AI sludge)
- Explicit heading hierarchy (no bare Tailwind `prose` dependency)
- Link map, list, harvest, day planner, related guides
- Confirm-with-estate disclaimer; 21+ responsible tone
- Ship to `/guides/<slug>/` + add to `guides/index.astro`

## Queue (order)

| Day | # | Slug | Title | Status |
|-----|---|------|-------|--------|
| 1 | 9 | `how-many-wineries-one-day` | How Many Wineries to Visit in One Day | **done 2026-09-06** |
| 1 | 10 | `de-portola-road-wine-tasting` | De Portola Road Wine Tasting Guide | **done 2026-09-06** |
| 2–3 | 11 | `rancho-california-road-wine-tasting` | Rancho California Road Corridor Guide | **done 2026-09-08** (catch-up) |
...
2. first-timer-tasting-route  
3. pet-friendly-wineries  
4. sip-with-a-view  
5. temecula-harvest-season  
6. temecula-red-varietals  
7. weekday-vs-weekend-tasting  
8. weekend-in-temecula-wine-country  
